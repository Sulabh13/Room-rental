...
const MyRooms = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 pt-16">
      ...
      {toast && (
        <div
          className={`fixed top-5 right-5 z-[999] px-5 py-3 rounded-xl shadow-lg text-white text-sm font-medium
      ...
      {/* ── MAIN CONTENT ── */}
      <div className="flex-1 md:ml-64 min-h-[calc(100vh-64px)] flex flex-col">
        {/* ── MOBILE TOPBAR ── */}
