    ...
    <div className={styles.root}>
      <div className={styles.inner}>
        ...
        <div className={styles.left}>
          ...
          <div
            className={`${styles.testimonial} ${fading ? styles.testimonialFading : styles.testimonialVisible}`}
          >
