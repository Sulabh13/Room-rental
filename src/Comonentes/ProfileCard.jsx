...
import { User, LogOut, LayoutDashboard, Heart, KeyRound } from "lucide-react";
        ...
        >
          ...
          <div className="p-2 space-y-1">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 hover:bg-gray-100 rounded-lg text-sm transition w-full text-left"
            >
